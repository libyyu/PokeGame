...
public class Lua_WeChatWASM_AddCardOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.AddCardOption o;
			o=new WeChatWASM.AddCardOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_cardList(IntPtr l) {
		try {
			WeChatWASM.AddCardOption self=(WeChatWASM.AddCardOption)checkSelf(l);
			pushValue(l,true);
	...
	static public int set_cardList(IntPtr l) {
		try {
			WeChatWASM.AddCardOption self=(WeChatWASM.AddCardOption)checkSelf(l);
			WeChatWASM.AddCardRequestInfo[] v;
	...
	static public int set_success(IntPtr l) {
		try {
			WeChatWASM.AddCardOption self=(WeChatWASM.AddCardOption)checkSelf(l);
			System.Action<WeChatWASM.AddCardSuccessCallbackResult> v;
			int op=checkDelegate(l,2,out v);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.AddCardOption");
		...
		createTypeMetatable(l,constructor, typeof(WeChatWASM.AddCardOption));
	}
}
