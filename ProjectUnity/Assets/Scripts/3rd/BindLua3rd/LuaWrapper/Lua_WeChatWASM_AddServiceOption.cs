...
public class Lua_WeChatWASM_AddServiceOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.AddServiceOption o;
			o=new WeChatWASM.AddServiceOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_service(IntPtr l) {
		try {
			WeChatWASM.AddServiceOption self=(WeChatWASM.AddServiceOption)checkSelf(l);
			pushValue(l,true);
			pushValue(l,self.service);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int set_service(IntPtr l) {
		try {
			WeChatWASM.AddServiceOption self=(WeChatWASM.AddServiceOption)checkSelf(l);
			WeChatWASM.BLEPeripheralService v;
			checkType(l,2,out v);
			self.service=v;
			pushValue(l,true);
			return 1;
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.AddServiceOption");
		addMember(l,"service",get_service,set_service,true);
		addMember(l,"complete",null,set_complete,true);
		addMember(l,"fail",null,set_fail,true);
		addMember(l,"success",null,set_success,true);
		createTypeMetatable(l,constructor, typeof(WeChatWASM.AddServiceOption));
	}
}
