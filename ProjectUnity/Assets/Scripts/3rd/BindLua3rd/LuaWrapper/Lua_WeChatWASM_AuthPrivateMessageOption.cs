...
public class Lua_WeChatWASM_AuthPrivateMessageOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.AuthPrivateMessageOption o;
			o=new WeChatWASM.AuthPrivateMessageOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_shareTicket(IntPtr l) {
		try {
			WeChatWASM.AuthPrivateMessageOption self=(WeChatWASM.AuthPrivateMessageOption)checkSelf(l);
			pushValue(l,true);
	...
	static public int set_success(IntPtr l) {
		try {
			WeChatWASM.AuthPrivateMessageOption self=(WeChatWASM.AuthPrivateMessageOption)checkSelf(l);
			System.Action<WeChatWASM.AuthPrivateMessageSuccessCallbackResult> v;
			int op=checkDelegate(l,2,out v);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.AuthPrivateMessageOption");
		...
		createTypeMetatable(l,constructor, typeof(WeChatWASM.AuthPrivateMessageOption));
	}
}
