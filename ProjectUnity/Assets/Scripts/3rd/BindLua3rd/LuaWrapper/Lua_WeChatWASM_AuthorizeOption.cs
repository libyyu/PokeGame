...
public class Lua_WeChatWASM_AuthorizeOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.AuthorizeOption o;
			o=new WeChatWASM.AuthorizeOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_scope(IntPtr l) {
		try {
			WeChatWASM.AuthorizeOption self=(WeChatWASM.AuthorizeOption)checkSelf(l);
			pushValue(l,true);
			pushValue(l,self.scope);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int set_scope(IntPtr l) {
		try {
			WeChatWASM.AuthorizeOption self=(WeChatWASM.AuthorizeOption)checkSelf(l);
			System.String v;
			checkType(l,2,out v);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.AuthorizeOption");
		addMember(l,"scope",get_scope,set_scope,true);
		addMember(l,"complete",null,set_complete,true);
		addMember(l,"fail",null,set_fail,true);
		addMember(l,"success",null,set_success,true);
		createTypeMetatable(l,constructor, typeof(WeChatWASM.AuthorizeOption));
	}
}
