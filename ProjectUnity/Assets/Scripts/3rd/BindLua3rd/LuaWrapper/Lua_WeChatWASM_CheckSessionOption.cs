...
public class Lua_WeChatWASM_CheckSessionOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.CheckSessionOption o;
			o=new WeChatWASM.CheckSessionOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int set_complete(IntPtr l) {
		try {
			WeChatWASM.CheckSessionOption self=(WeChatWASM.CheckSessionOption)checkSelf(l);
