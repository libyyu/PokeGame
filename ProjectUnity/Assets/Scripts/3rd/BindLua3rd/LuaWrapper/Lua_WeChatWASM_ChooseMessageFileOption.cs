...
public class Lua_WeChatWASM_ChooseMessageFileOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.ChooseMessageFileOption o;
			o=new WeChatWASM.ChooseMessageFileOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_count(IntPtr l) {
		try {
			WeChatWASM.ChooseMessageFileOption self=(WeChatWASM.ChooseMessageFileOption)checkSelf(l);
			pushValue(l,true);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_extension(IntPtr l) {
		try {
			WeChatWASM.ChooseMessageFileOption self=(WeChatWASM.ChooseMessageFileOption)checkSelf(l);
			pushValue(l,true);
			pushValue(l,self.extension);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int set_extension(IntPtr l) {
		try {
			WeChatWASM.ChooseMessageFileOption self=(WeChatWASM.ChooseMessageFileOption)checkSelf(l);
			System.String[] v;
	...
	static public int set_success(IntPtr l) {
		try {
			WeChatWASM.ChooseMessageFileOption self=(WeChatWASM.ChooseMessageFileOption)checkSelf(l);
			System.Action<WeChatWASM.ChooseMessageFileSuccessCallbackResult> v;
			int op=checkDelegate(l,2,out v);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.ChooseMessageFileOption");
		addMember(l,"count",get_count,set_count,true);
		addMember(l,"complete",null,set_complete,true);
		addMember(l,"extension",get_extension,set_extension,true);
		addMember(l,"fail",null,set_fail,true);
		addMember(l,"success",null,set_success,true);
		addMember(l,"type",get_type,set_type,true);
		createTypeMetatable(l,constructor, typeof(WeChatWASM.ChooseMessageFileOption));
	}
}
