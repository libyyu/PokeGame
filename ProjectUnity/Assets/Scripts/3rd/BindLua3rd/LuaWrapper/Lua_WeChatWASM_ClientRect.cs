...
public class Lua_WeChatWASM_ClientRect : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.ClientRect o;
			o=new WeChatWASM.ClientRect();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_bottom(IntPtr l) {
		try {
			WeChatWASM.ClientRect self=(WeChatWASM.ClientRect)checkSelf(l);
			pushValue(l,true);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.ClientRect");
		...
		createTypeMetatable(l,constructor, typeof(WeChatWASM.ClientRect));
	}
}
