...
public class Lua_WeChatWASM_CloseBLEConnectionOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.CloseBLEConnectionOption o;
			o=new WeChatWASM.CloseBLEConnectionOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_deviceId(IntPtr l) {
		try {
			WeChatWASM.CloseBLEConnectionOption self=(WeChatWASM.CloseBLEConnectionOption)checkSelf(l);
			pushValue(l,true);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.CloseBLEConnectionOption");
		...
		createTypeMetatable(l,constructor, typeof(WeChatWASM.CloseBLEConnectionOption));
	}
}
