...
public class Lua_WeChatWASM_CreateBLEConnectionOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.CreateBLEConnectionOption o;
			o=new WeChatWASM.CreateBLEConnectionOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_deviceId(IntPtr l) {
		try {
			WeChatWASM.CreateBLEConnectionOption self=(WeChatWASM.CreateBLEConnectionOption)checkSelf(l);
			pushValue(l,true);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.CreateBLEConnectionOption");
		...
		createTypeMetatable(l,constructor, typeof(WeChatWASM.CreateBLEConnectionOption));
	}
}
