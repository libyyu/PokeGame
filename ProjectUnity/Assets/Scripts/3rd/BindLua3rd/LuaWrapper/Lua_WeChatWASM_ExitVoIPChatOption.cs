...
public class Lua_WeChatWASM_ExitVoIPChatOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.ExitVoIPChatOption o;
			o=new WeChatWASM.ExitVoIPChatOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int set_complete(IntPtr l) {
		try {
			WeChatWASM.ExitVoIPChatOption self=(WeChatWASM.ExitVoIPChatOption)checkSelf(l);
