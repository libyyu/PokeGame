...
public class Lua_WeChatWASM_FileError : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.FileError o;
			o=new WeChatWASM.FileError();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_errMsg(IntPtr l) {
		try {
			WeChatWASM.FileError self=(WeChatWASM.FileError)checkSelf(l);
			pushValue(l,true);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.FileError");
		addMember(l,"errMsg",get_errMsg,set_errMsg,true);
		addMember(l,"errCode",get_errCode,set_errCode,true);
		createTypeMetatable(l,constructor, typeof(WeChatWASM.FileError));
	}
}
