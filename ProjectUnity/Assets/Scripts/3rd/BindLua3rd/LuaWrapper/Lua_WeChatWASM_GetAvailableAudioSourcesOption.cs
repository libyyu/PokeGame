...
public class Lua_WeChatWASM_GetAvailableAudioSourcesOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.GetAvailableAudioSourcesOption o;
			o=new WeChatWASM.GetAvailableAudioSourcesOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int set_complete(IntPtr l) {
		try {
			WeChatWASM.GetAvailableAudioSourcesOption self=(WeChatWASM.GetAvailableAudioSourcesOption)checkSelf(l);
	...
	static public int set_success(IntPtr l) {
		try {
			WeChatWASM.GetAvailableAudioSourcesOption self=(WeChatWASM.GetAvailableAudioSourcesOption)checkSelf(l);
			System.Action<WeChatWASM.GetAvailableAudioSourcesSuccessCallbackResult> v;
			int op=checkDelegate(l,2,out v);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.GetAvailableAudioSourcesOption");
		addMember(l,"complete",null,set_complete,true);
		addMember(l,"fail",null,set_fail,true);
		addMember(l,"success",null,set_success,true);
		createTypeMetatable(l,constructor, typeof(WeChatWASM.GetAvailableAudioSourcesOption));
	}
}
