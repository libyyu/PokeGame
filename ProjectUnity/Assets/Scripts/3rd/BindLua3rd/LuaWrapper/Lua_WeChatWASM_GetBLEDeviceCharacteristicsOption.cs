...
public class Lua_WeChatWASM_GetBLEDeviceCharacteristicsOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.GetBLEDeviceCharacteristicsOption o;
			o=new WeChatWASM.GetBLEDeviceCharacteristicsOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_deviceId(IntPtr l) {
		try {
			WeChatWASM.GetBLEDeviceCharacteristicsOption self=(WeChatWASM.GetBLEDeviceCharacteristicsOption)checkSelf(l);
			pushValue(l,true);
	...
	static public int set_success(IntPtr l) {
		try {
			WeChatWASM.GetBLEDeviceCharacteristicsOption self=(WeChatWASM.GetBLEDeviceCharacteristicsOption)checkSelf(l);
			System.Action<WeChatWASM.GetBLEDeviceCharacteristicsSuccessCallbackResult> v;
			int op=checkDelegate(l,2,out v);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.GetBLEDeviceCharacteristicsOption");
		...
		createTypeMetatable(l,constructor, typeof(WeChatWASM.GetBLEDeviceCharacteristicsOption));
	}
}
