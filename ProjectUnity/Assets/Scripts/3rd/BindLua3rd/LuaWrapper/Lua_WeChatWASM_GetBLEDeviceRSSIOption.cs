...
public class Lua_WeChatWASM_GetBLEDeviceRSSIOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.GetBLEDeviceRSSIOption o;
			o=new WeChatWASM.GetBLEDeviceRSSIOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_deviceId(IntPtr l) {
		try {
			WeChatWASM.GetBLEDeviceRSSIOption self=(WeChatWASM.GetBLEDeviceRSSIOption)checkSelf(l);
			pushValue(l,true);
	...
	static public int set_success(IntPtr l) {
		try {
			WeChatWASM.GetBLEDeviceRSSIOption self=(WeChatWASM.GetBLEDeviceRSSIOption)checkSelf(l);
			System.Action<WeChatWASM.GetBLEDeviceRSSISuccessCallbackResult> v;
			int op=checkDelegate(l,2,out v);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.GetBLEDeviceRSSIOption");
		...
		createTypeMetatable(l,constructor, typeof(WeChatWASM.GetBLEDeviceRSSIOption));
	}
}
