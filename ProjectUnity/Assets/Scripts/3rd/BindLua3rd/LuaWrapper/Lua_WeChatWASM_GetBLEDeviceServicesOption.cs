...
public class Lua_WeChatWASM_GetBLEDeviceServicesOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.GetBLEDeviceServicesOption o;
			o=new WeChatWASM.GetBLEDeviceServicesOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_deviceId(IntPtr l) {
		try {
			WeChatWASM.GetBLEDeviceServicesOption self=(WeChatWASM.GetBLEDeviceServicesOption)checkSelf(l);
			pushValue(l,true);
	...
	static public int set_success(IntPtr l) {
		try {
			WeChatWASM.GetBLEDeviceServicesOption self=(WeChatWASM.GetBLEDeviceServicesOption)checkSelf(l);
			System.Action<WeChatWASM.GetBLEDeviceServicesSuccessCallbackResult> v;
			int op=checkDelegate(l,2,out v);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.GetBLEDeviceServicesOption");
		...
		createTypeMetatable(l,constructor, typeof(WeChatWASM.GetBLEDeviceServicesOption));
	}
}
