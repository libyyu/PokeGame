...
public class Lua_WeChatWASM_GetBLEMTUOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.GetBLEMTUOption o;
			o=new WeChatWASM.GetBLEMTUOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_deviceId(IntPtr l) {
		try {
			WeChatWASM.GetBLEMTUOption self=(WeChatWASM.GetBLEMTUOption)checkSelf(l);
			pushValue(l,true);
	...
	static public int set_success(IntPtr l) {
		try {
			WeChatWASM.GetBLEMTUOption self=(WeChatWASM.GetBLEMTUOption)checkSelf(l);
			System.Action<WeChatWASM.GetBLEMTUSuccessCallbackResult> v;
			int op=checkDelegate(l,2,out v);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.GetBLEMTUOption");
		...
		createTypeMetatable(l,constructor, typeof(WeChatWASM.GetBLEMTUOption));
	}
}
