...
public class Lua_WeChatWASM_GetBackgroundFetchDataOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.GetBackgroundFetchDataOption o;
			o=new WeChatWASM.GetBackgroundFetchDataOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_fetchType(IntPtr l) {
		try {
			WeChatWASM.GetBackgroundFetchDataOption self=(WeChatWASM.GetBackgroundFetchDataOption)checkSelf(l);
			pushValue(l,true);
	...
	static public int set_success(IntPtr l) {
		try {
			WeChatWASM.GetBackgroundFetchDataOption self=(WeChatWASM.GetBackgroundFetchDataOption)checkSelf(l);
			System.Action<WeChatWASM.GetBackgroundFetchDataSuccessCallbackResult> v;
			int op=checkDelegate(l,2,out v);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.GetBackgroundFetchDataOption");
		...
		createTypeMetatable(l,constructor, typeof(WeChatWASM.GetBackgroundFetchDataOption));
	}
}
