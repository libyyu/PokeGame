...
public class Lua_WeChatWASM_GetBackgroundFetchTokenOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.GetBackgroundFetchTokenOption o;
			o=new WeChatWASM.GetBackgroundFetchTokenOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int set_complete(IntPtr l) {
		try {
			WeChatWASM.GetBackgroundFetchTokenOption self=(WeChatWASM.GetBackgroundFetchTokenOption)checkSelf(l);
	...
	static public int set_success(IntPtr l) {
		try {
			WeChatWASM.GetBackgroundFetchTokenOption self=(WeChatWASM.GetBackgroundFetchTokenOption)checkSelf(l);
			System.Action<WeChatWASM.GetBackgroundFetchTokenSuccessCallbackResult> v;
			int op=checkDelegate(l,2,out v);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.GetBackgroundFetchTokenOption");
		addMember(l,"complete",null,set_complete,true);
		addMember(l,"fail",null,set_fail,true);
		addMember(l,"success",null,set_success,true);
		createTypeMetatable(l,constructor, typeof(WeChatWASM.GetBackgroundFetchTokenOption));
	}
}
