...
public class Lua_WeChatWASM_GetBatteryInfoOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.GetBatteryInfoOption o;
			o=new WeChatWASM.GetBatteryInfoOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int set_complete(IntPtr l) {
		try {
			WeChatWASM.GetBatteryInfoOption self=(WeChatWASM.GetBatteryInfoOption)checkSelf(l);
	...
	static public int set_success(IntPtr l) {
		try {
			WeChatWASM.GetBatteryInfoOption self=(WeChatWASM.GetBatteryInfoOption)checkSelf(l);
			System.Action<WeChatWASM.GetBatteryInfoSuccessCallbackResult> v;
			int op=checkDelegate(l,2,out v);
