...
public class Lua_WeChatWASM_GetBeaconsOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.GetBeaconsOption o;
			o=new WeChatWASM.GetBeaconsOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int set_complete(IntPtr l) {
		try {
			WeChatWASM.GetBeaconsOption self=(WeChatWASM.GetBeaconsOption)checkSelf(l);
	...
	static public int set_success(IntPtr l) {
		try {
			WeChatWASM.GetBeaconsOption self=(WeChatWASM.GetBeaconsOption)checkSelf(l);
			System.Action<WeChatWASM.GetBeaconsSuccessCallbackResult> v;
			int op=checkDelegate(l,2,out v);
