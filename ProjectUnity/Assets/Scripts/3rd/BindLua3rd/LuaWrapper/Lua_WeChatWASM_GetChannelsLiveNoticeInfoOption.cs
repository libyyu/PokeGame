...
public class Lua_WeChatWASM_GetChannelsLiveNoticeInfoOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.GetChannelsLiveNoticeInfoOption o;
			o=new WeChatWASM.GetChannelsLiveNoticeInfoOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_finderUserName(IntPtr l) {
		try {
			WeChatWASM.GetChannelsLiveNoticeInfoOption self=(WeChatWASM.GetChannelsLiveNoticeInfoOption)checkSelf(l);
			pushValue(l,true);
	...
	static public int set_success(IntPtr l) {
		try {
			WeChatWASM.GetChannelsLiveNoticeInfoOption self=(WeChatWASM.GetChannelsLiveNoticeInfoOption)checkSelf(l);
			System.Action<WeChatWASM.GetChannelsLiveNoticeInfoSuccessCallbackResult> v;
			int op=checkDelegate(l,2,out v);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.GetChannelsLiveNoticeInfoOption");
		...
		createTypeMetatable(l,constructor, typeof(WeChatWASM.GetChannelsLiveNoticeInfoOption));
	}
}
