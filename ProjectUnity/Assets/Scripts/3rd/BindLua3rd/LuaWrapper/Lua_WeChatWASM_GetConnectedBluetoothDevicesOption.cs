...
public class Lua_WeChatWASM_GetConnectedBluetoothDevicesOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.GetConnectedBluetoothDevicesOption o;
			o=new WeChatWASM.GetConnectedBluetoothDevicesOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_services(IntPtr l) {
		try {
			WeChatWASM.GetConnectedBluetoothDevicesOption self=(WeChatWASM.GetConnectedBluetoothDevicesOption)checkSelf(l);
			pushValue(l,true);
	...
	static public int set_success(IntPtr l) {
		try {
			WeChatWASM.GetConnectedBluetoothDevicesOption self=(WeChatWASM.GetConnectedBluetoothDevicesOption)checkSelf(l);
			System.Action<WeChatWASM.GetConnectedBluetoothDevicesSuccessCallbackResult> v;
			int op=checkDelegate(l,2,out v);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.GetConnectedBluetoothDevicesOption");
		...
		createTypeMetatable(l,constructor, typeof(WeChatWASM.GetConnectedBluetoothDevicesOption));
	}
}
