...
public class Lua_WeChatWASM_GetExtConfigOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.GetExtConfigOption o;
			o=new WeChatWASM.GetExtConfigOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int set_complete(IntPtr l) {
		try {
			WeChatWASM.GetExtConfigOption self=(WeChatWASM.GetExtConfigOption)checkSelf(l);
	...
	static public int set_success(IntPtr l) {
		try {
			WeChatWASM.GetExtConfigOption self=(WeChatWASM.GetExtConfigOption)checkSelf(l);
			System.Action<WeChatWASM.GetExtConfigSuccessCallbackResult> v;
			int op=checkDelegate(l,2,out v);
