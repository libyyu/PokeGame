...
public class Lua_WeChatWASM_GetFuzzyLocationOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.GetFuzzyLocationOption o;
			o=new WeChatWASM.GetFuzzyLocationOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int set_complete(IntPtr l) {
		try {
			WeChatWASM.GetFuzzyLocationOption self=(WeChatWASM.GetFuzzyLocationOption)checkSelf(l);
	...
	static public int set_success(IntPtr l) {
		try {
			WeChatWASM.GetFuzzyLocationOption self=(WeChatWASM.GetFuzzyLocationOption)checkSelf(l);
			System.Action<WeChatWASM.GetFuzzyLocationSuccessCallbackResult> v;
			int op=checkDelegate(l,2,out v);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.GetFuzzyLocationOption");
		...
		createTypeMetatable(l,constructor, typeof(WeChatWASM.GetFuzzyLocationOption));
	}
}
