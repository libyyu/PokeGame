...
public class Lua_WeChatWASM_GetGameClubDataSuccessCallbackResult : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.GetGameClubDataSuccessCallbackResult o;
			o=new WeChatWASM.GetGameClubDataSuccessCallbackResult();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_cloudID(IntPtr l) {
		try {
			WeChatWASM.GetGameClubDataSuccessCallbackResult self=(WeChatWASM.GetGameClubDataSuccessCallbackResult)checkSelf(l);
			pushValue(l,true);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.GetGameClubDataSuccessCallbackResult");
		...
		createTypeMetatable(l,constructor, typeof(WeChatWASM.GetGameClubDataSuccessCallbackResult));
	}
}
