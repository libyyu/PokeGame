...
public class Lua_WeChatWASM_GetGroupEnterInfoSuccessCallbackResult : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.GetGroupEnterInfoSuccessCallbackResult o;
			o=new WeChatWASM.GetGroupEnterInfoSuccessCallbackResult();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_cloudID(IntPtr l) {
		try {
			WeChatWASM.GetGroupEnterInfoSuccessCallbackResult self=(WeChatWASM.GetGroupEnterInfoSuccessCallbackResult)checkSelf(l);
			pushValue(l,true);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.GetGroupEnterInfoSuccessCallbackResult");
		...
		createTypeMetatable(l,constructor, typeof(WeChatWASM.GetGroupEnterInfoSuccessCallbackResult));
	}
}
