...
public class Lua_WeChatWASM_GetLocalIPAddressOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.GetLocalIPAddressOption o;
			o=new WeChatWASM.GetLocalIPAddressOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int set_complete(IntPtr l) {
		try {
			WeChatWASM.GetLocalIPAddressOption self=(WeChatWASM.GetLocalIPAddressOption)checkSelf(l);
	...
	static public int set_success(IntPtr l) {
		try {
			WeChatWASM.GetLocalIPAddressOption self=(WeChatWASM.GetLocalIPAddressOption)checkSelf(l);
			System.Action<WeChatWASM.GetLocalIPAddressSuccessCallbackResult> v;
			int op=checkDelegate(l,2,out v);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.GetLocalIPAddressOption");
		addMember(l,"complete",null,set_complete,true);
		addMember(l,"fail",null,set_fail,true);
		addMember(l,"success",null,set_success,true);
		createTypeMetatable(l,constructor, typeof(WeChatWASM.GetLocalIPAddressOption));
	}
}
