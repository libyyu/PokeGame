...
public class Lua_WeChatWASM_GetNetworkTypeOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.GetNetworkTypeOption o;
			o=new WeChatWASM.GetNetworkTypeOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int set_complete(IntPtr l) {
		try {
			WeChatWASM.GetNetworkTypeOption self=(WeChatWASM.GetNetworkTypeOption)checkSelf(l);
	...
	static public int set_success(IntPtr l) {
		try {
			WeChatWASM.GetNetworkTypeOption self=(WeChatWASM.GetNetworkTypeOption)checkSelf(l);
			System.Action<WeChatWASM.GetNetworkTypeSuccessCallbackResult> v;
			int op=checkDelegate(l,2,out v);
