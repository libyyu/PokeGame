...
public class Lua_WeChatWASM_GetShareInfoOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.GetShareInfoOption o;
			o=new WeChatWASM.GetShareInfoOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_shareTicket(IntPtr l) {
		try {
			WeChatWASM.GetShareInfoOption self=(WeChatWASM.GetShareInfoOption)checkSelf(l);
			pushValue(l,true);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.GetShareInfoOption");
		...
		createTypeMetatable(l,constructor, typeof(WeChatWASM.GetShareInfoOption));
	}
}
