...
public class Lua_WeChatWASM_GetStorageInfoOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.GetStorageInfoOption o;
			o=new WeChatWASM.GetStorageInfoOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int set_complete(IntPtr l) {
		try {
			WeChatWASM.GetStorageInfoOption self=(WeChatWASM.GetStorageInfoOption)checkSelf(l);
	...
	static public int set_success(IntPtr l) {
		try {
			WeChatWASM.GetStorageInfoOption self=(WeChatWASM.GetStorageInfoOption)checkSelf(l);
			System.Action<WeChatWASM.GetStorageInfoSuccessCallbackOption> v;
			int op=checkDelegate(l,2,out v);
