...
public class Lua_WeChatWASM_GetSystemInfoOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.GetSystemInfoOption o;
			o=new WeChatWASM.GetSystemInfoOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int set_complete(IntPtr l) {
		try {
			WeChatWASM.GetSystemInfoOption self=(WeChatWASM.GetSystemInfoOption)checkSelf(l);
