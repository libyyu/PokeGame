...
public class Lua_WeChatWASM_GetUserGameLiveDetailsOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.GetUserGameLiveDetailsOption o;
			o=new WeChatWASM.GetUserGameLiveDetailsOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_feedIdList(IntPtr l) {
		try {
			WeChatWASM.GetUserGameLiveDetailsOption self=(WeChatWASM.GetUserGameLiveDetailsOption)checkSelf(l);
			pushValue(l,true);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.GetUserGameLiveDetailsOption");
		...
		createTypeMetatable(l,constructor, typeof(WeChatWASM.GetUserGameLiveDetailsOption));
	}
}
