...
public class Lua_WeChatWASM_GetWeRunDataOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.GetWeRunDataOption o;
			o=new WeChatWASM.GetWeRunDataOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int set_complete(IntPtr l) {
		try {
			WeChatWASM.GetWeRunDataOption self=(WeChatWASM.GetWeRunDataOption)checkSelf(l);
	...
	static public int set_success(IntPtr l) {
		try {
			WeChatWASM.GetWeRunDataOption self=(WeChatWASM.GetWeRunDataOption)checkSelf(l);
			System.Action<WeChatWASM.GetWeRunDataSuccessCallbackResult> v;
			int op=checkDelegate(l,2,out v);
