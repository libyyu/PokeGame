...
public class Lua_WeChatWASM_GetWeRunDataSuccessCallbackResult : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.GetWeRunDataSuccessCallbackResult o;
			o=new WeChatWASM.GetWeRunDataSuccessCallbackResult();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_cloudID(IntPtr l) {
		try {
			WeChatWASM.GetWeRunDataSuccessCallbackResult self=(WeChatWASM.GetWeRunDataSuccessCallbackResult)checkSelf(l);
			pushValue(l,true);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.GetWeRunDataSuccessCallbackResult");
		...
		createTypeMetatable(l,constructor, typeof(WeChatWASM.GetWeRunDataSuccessCallbackResult));
	}
}
