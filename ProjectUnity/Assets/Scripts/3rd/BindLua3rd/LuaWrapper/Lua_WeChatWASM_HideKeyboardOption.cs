...
public class Lua_WeChatWASM_HideKeyboardOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.HideKeyboardOption o;
			o=new WeChatWASM.HideKeyboardOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int set_complete(IntPtr l) {
		try {
			WeChatWASM.HideKeyboardOption self=(WeChatWASM.HideKeyboardOption)checkSelf(l);
