...
public class Lua_WeChatWASM_HideLoadingOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.HideLoadingOption o;
			o=new WeChatWASM.HideLoadingOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int set_complete(IntPtr l) {
		try {
			WeChatWASM.HideLoadingOption self=(WeChatWASM.HideLoadingOption)checkSelf(l);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_noConflict(IntPtr l) {
		try {
			WeChatWASM.HideLoadingOption self=(WeChatWASM.HideLoadingOption)checkSelf(l);
			pushValue(l,true);
			pushValue(l,self.noConflict);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int set_noConflict(IntPtr l) {
		try {
			WeChatWASM.HideLoadingOption self=(WeChatWASM.HideLoadingOption)checkSelf(l);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.HideLoadingOption");
		addMember(l,"complete",null,set_complete,true);
		addMember(l,"fail",null,set_fail,true);
		addMember(l,"noConflict",get_noConflict,set_noConflict,true);
		addMember(l,"success",null,set_success,true);
		createTypeMetatable(l,constructor, typeof(WeChatWASM.HideLoadingOption));
	}
}
