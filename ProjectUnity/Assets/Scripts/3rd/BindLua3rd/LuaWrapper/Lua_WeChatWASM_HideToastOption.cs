...
public class Lua_WeChatWASM_HideToastOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.HideToastOption o;
			o=new WeChatWASM.HideToastOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int set_complete(IntPtr l) {
		try {
			WeChatWASM.HideToastOption self=(WeChatWASM.HideToastOption)checkSelf(l);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.HideToastOption");
		...
		createTypeMetatable(l,constructor, typeof(WeChatWASM.HideToastOption));
	}
}
