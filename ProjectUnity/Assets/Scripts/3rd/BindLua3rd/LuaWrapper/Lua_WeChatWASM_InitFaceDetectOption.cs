...
public class Lua_WeChatWASM_InitFaceDetectOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.InitFaceDetectOption o;
			o=new WeChatWASM.InitFaceDetectOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int set_complete(IntPtr l) {
		try {
			WeChatWASM.InitFaceDetectOption self=(WeChatWASM.InitFaceDetectOption)checkSelf(l);
