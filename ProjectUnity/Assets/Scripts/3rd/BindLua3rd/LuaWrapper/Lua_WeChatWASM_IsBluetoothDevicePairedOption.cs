...
public class Lua_WeChatWASM_IsBluetoothDevicePairedOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.IsBluetoothDevicePairedOption o;
			o=new WeChatWASM.IsBluetoothDevicePairedOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_deviceId(IntPtr l) {
		try {
			WeChatWASM.IsBluetoothDevicePairedOption self=(WeChatWASM.IsBluetoothDevicePairedOption)checkSelf(l);
			pushValue(l,true);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.IsBluetoothDevicePairedOption");
		...
		createTypeMetatable(l,constructor, typeof(WeChatWASM.IsBluetoothDevicePairedOption));
	}
}
