...
public class Lua_WeChatWASM_JoinVoIPChatSuccessCallbackResult : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.JoinVoIPChatSuccessCallbackResult o;
			o=new WeChatWASM.JoinVoIPChatSuccessCallbackResult();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_errCode(IntPtr l) {
		try {
			WeChatWASM.JoinVoIPChatSuccessCallbackResult self=(WeChatWASM.JoinVoIPChatSuccessCallbackResult)checkSelf(l);
			pushValue(l,true);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.JoinVoIPChatSuccessCallbackResult");
		...
		createTypeMetatable(l,constructor, typeof(WeChatWASM.JoinVoIPChatSuccessCallbackResult));
	}
}
