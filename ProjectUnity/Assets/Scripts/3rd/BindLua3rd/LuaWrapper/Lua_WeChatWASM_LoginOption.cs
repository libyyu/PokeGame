...
public class Lua_WeChatWASM_LoginOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.LoginOption o;
			o=new WeChatWASM.LoginOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int set_complete(IntPtr l) {
		try {
			WeChatWASM.LoginOption self=(WeChatWASM.LoginOption)checkSelf(l);
	...
	static public int set_fail(IntPtr l) {
		try {
			WeChatWASM.LoginOption self=(WeChatWASM.LoginOption)checkSelf(l);
			System.Action<WeChatWASM.RequestFailCallbackErr> v;
			int op=checkDelegate(l,2,out v);
			if(op==0) self.fail=v;
	...
	static public int set_success(IntPtr l) {
		try {
			WeChatWASM.LoginOption self=(WeChatWASM.LoginOption)checkSelf(l);
			System.Action<WeChatWASM.LoginSuccessCallbackResult> v;
			int op=checkDelegate(l,2,out v);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.LoginOption");
		...
		createTypeMetatable(l,constructor, typeof(WeChatWASM.LoginOption));
	}
}
