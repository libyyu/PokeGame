...
public class Lua_WeChatWASM_MkdirParam : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.MkdirParam o;
			o=new WeChatWASM.MkdirParam();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_dirPath(IntPtr l) {
		try {
			WeChatWASM.MkdirParam self=(WeChatWASM.MkdirParam)checkSelf(l);
			pushValue(l,true);
