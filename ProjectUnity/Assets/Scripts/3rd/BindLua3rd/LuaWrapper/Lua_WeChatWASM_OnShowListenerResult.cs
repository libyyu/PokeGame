...
public class Lua_WeChatWASM_OnShowListenerResult : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.OnShowListenerResult o;
			o=new WeChatWASM.OnShowListenerResult();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_query(IntPtr l) {
		try {
			WeChatWASM.OnShowListenerResult self=(WeChatWASM.OnShowListenerResult)checkSelf(l);
			pushValue(l,true);
	...
	static public int set_referrerInfo(IntPtr l) {
		try {
			WeChatWASM.OnShowListenerResult self=(WeChatWASM.OnShowListenerResult)checkSelf(l);
			WeChatWASM.ResultReferrerInfo v;
			checkType(l,2,out v);
			self.referrerInfo=v;
			pushValue(l,true);
			return 1;
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.OnShowListenerResult");
		...
		createTypeMetatable(l,constructor, typeof(WeChatWASM.OnShowListenerResult));
	}
}
