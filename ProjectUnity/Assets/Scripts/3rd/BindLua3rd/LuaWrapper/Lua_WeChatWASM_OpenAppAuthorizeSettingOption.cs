...
public class Lua_WeChatWASM_OpenAppAuthorizeSettingOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.OpenAppAuthorizeSettingOption o;
			o=new WeChatWASM.OpenAppAuthorizeSettingOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int set_complete(IntPtr l) {
		try {
			WeChatWASM.OpenAppAuthorizeSettingOption self=(WeChatWASM.OpenAppAuthorizeSettingOption)checkSelf(l);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.OpenAppAuthorizeSettingOption");
		addMember(l,"complete",null,set_complete,true);
		addMember(l,"fail",null,set_fail,true);
		addMember(l,"success",null,set_success,true);
		createTypeMetatable(l,constructor, typeof(WeChatWASM.OpenAppAuthorizeSettingOption));
	}
}
