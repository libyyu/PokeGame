...
public class Lua_WeChatWASM_OpenCardOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.OpenCardOption o;
			o=new WeChatWASM.OpenCardOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_cardList(IntPtr l) {
		try {
			WeChatWASM.OpenCardOption self=(WeChatWASM.OpenCardOption)checkSelf(l);
			pushValue(l,true);
	...
	static public int set_cardList(IntPtr l) {
		try {
			WeChatWASM.OpenCardOption self=(WeChatWASM.OpenCardOption)checkSelf(l);
			WeChatWASM.OpenCardRequestInfo[] v;
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.OpenCardOption");
		...
		createTypeMetatable(l,constructor, typeof(WeChatWASM.OpenCardOption));
	}
}
