...
public class Lua_WeChatWASM_OpenChannelsEventOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.OpenChannelsEventOption o;
			o=new WeChatWASM.OpenChannelsEventOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_eventId(IntPtr l) {
		try {
			WeChatWASM.OpenChannelsEventOption self=(WeChatWASM.OpenChannelsEventOption)checkSelf(l);
			pushValue(l,true);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.OpenChannelsEventOption");
		...
		createTypeMetatable(l,constructor, typeof(WeChatWASM.OpenChannelsEventOption));
	}
}
