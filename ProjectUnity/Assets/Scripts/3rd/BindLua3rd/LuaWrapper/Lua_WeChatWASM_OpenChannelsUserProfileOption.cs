...
public class Lua_WeChatWASM_OpenChannelsUserProfileOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.OpenChannelsUserProfileOption o;
			o=new WeChatWASM.OpenChannelsUserProfileOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_finderUserName(IntPtr l) {
		try {
			WeChatWASM.OpenChannelsUserProfileOption self=(WeChatWASM.OpenChannelsUserProfileOption)checkSelf(l);
			pushValue(l,true);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.OpenChannelsUserProfileOption");
		...
		createTypeMetatable(l,constructor, typeof(WeChatWASM.OpenChannelsUserProfileOption));
	}
}
