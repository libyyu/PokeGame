...
public class Lua_WeChatWASM_OpenOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.OpenOption o;
			o=new WeChatWASM.OpenOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_filePath(IntPtr l) {
		try {
			WeChatWASM.OpenOption self=(WeChatWASM.OpenOption)checkSelf(l);
			pushValue(l,true);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.OpenOption");
		addMember(l,"filePath",get_filePath,set_filePath,true);
		addMember(l,"flag",get_flag,set_flag,true);
		createTypeMetatable(l,constructor, typeof(WeChatWASM.OpenOption));
	}
}
