...
public class Lua_WeChatWASM_OpenPageOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.OpenPageOption o;
			o=new WeChatWASM.OpenPageOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_openlink(IntPtr l) {
		try {
			WeChatWASM.OpenPageOption self=(WeChatWASM.OpenPageOption)checkSelf(l);
			pushValue(l,true);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.OpenPageOption");
		...
		createTypeMetatable(l,constructor, typeof(WeChatWASM.OpenPageOption));
	}
}
