...
public class Lua_WeChatWASM_OpenSystemBluetoothSettingOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.OpenSystemBluetoothSettingOption o;
			o=new WeChatWASM.OpenSystemBluetoothSettingOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int set_complete(IntPtr l) {
		try {
			WeChatWASM.OpenSystemBluetoothSettingOption self=(WeChatWASM.OpenSystemBluetoothSettingOption)checkSelf(l);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.OpenSystemBluetoothSettingOption");
		addMember(l,"complete",null,set_complete,true);
		addMember(l,"fail",null,set_fail,true);
		addMember(l,"success",null,set_success,true);
		createTypeMetatable(l,constructor, typeof(WeChatWASM.OpenSystemBluetoothSettingOption));
	}
}
