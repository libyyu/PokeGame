...
public class Lua_WeChatWASM_ReadBLECharacteristicValueOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.ReadBLECharacteristicValueOption o;
			o=new WeChatWASM.ReadBLECharacteristicValueOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_characteristicId(IntPtr l) {
		try {
			WeChatWASM.ReadBLECharacteristicValueOption self=(WeChatWASM.ReadBLECharacteristicValueOption)checkSelf(l);
			pushValue(l,true);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.ReadBLECharacteristicValueOption");
		...
		createTypeMetatable(l,constructor, typeof(WeChatWASM.ReadBLECharacteristicValueOption));
	}
}
