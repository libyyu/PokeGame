...
public class Lua_WeChatWASM_ReadOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.ReadOption o;
			o=new WeChatWASM.ReadOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_arrayBuffer(IntPtr l) {
		try {
			WeChatWASM.ReadOption self=(WeChatWASM.ReadOption)checkSelf(l);
			pushValue(l,true);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.ReadOption");
		...
		createTypeMetatable(l,constructor, typeof(WeChatWASM.ReadOption));
	}
}
