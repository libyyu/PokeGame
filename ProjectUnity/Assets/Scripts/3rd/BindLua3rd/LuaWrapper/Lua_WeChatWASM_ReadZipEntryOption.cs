...
public class Lua_WeChatWASM_ReadZipEntryOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.ReadZipEntryOption o;
			o=new WeChatWASM.ReadZipEntryOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_entries(IntPtr l) {
		try {
			WeChatWASM.ReadZipEntryOption self=(WeChatWASM.ReadZipEntryOption)checkSelf(l);
			pushValue(l,true);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.ReadZipEntryOption");
		...
		createTypeMetatable(l,constructor, typeof(WeChatWASM.ReadZipEntryOption));
	}
}
