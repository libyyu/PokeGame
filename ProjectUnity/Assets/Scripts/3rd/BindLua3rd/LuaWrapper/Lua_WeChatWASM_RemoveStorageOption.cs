...
public class Lua_WeChatWASM_RemoveStorageOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.RemoveStorageOption o;
			o=new WeChatWASM.RemoveStorageOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_key(IntPtr l) {
		try {
			WeChatWASM.RemoveStorageOption self=(WeChatWASM.RemoveStorageOption)checkSelf(l);
			pushValue(l,true);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.RemoveStorageOption");
		...
		createTypeMetatable(l,constructor, typeof(WeChatWASM.RemoveStorageOption));
	}
}
