...
public class Lua_WeChatWASM_RemoveUserCloudStorageOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.RemoveUserCloudStorageOption o;
			o=new WeChatWASM.RemoveUserCloudStorageOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_keyList(IntPtr l) {
		try {
			WeChatWASM.RemoveUserCloudStorageOption self=(WeChatWASM.RemoveUserCloudStorageOption)checkSelf(l);
			pushValue(l,true);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.RemoveUserCloudStorageOption");
		...
		createTypeMetatable(l,constructor, typeof(WeChatWASM.RemoveUserCloudStorageOption));
	}
}
