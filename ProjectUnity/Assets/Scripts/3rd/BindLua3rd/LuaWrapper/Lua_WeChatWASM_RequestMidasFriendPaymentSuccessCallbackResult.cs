...
public class Lua_WeChatWASM_RequestMidasFriendPaymentSuccessCallbackResult : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.RequestMidasFriendPaymentSuccessCallbackResult o;
			o=new WeChatWASM.RequestMidasFriendPaymentSuccessCallbackResult();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_cloudID(IntPtr l) {
		try {
			WeChatWASM.RequestMidasFriendPaymentSuccessCallbackResult self=(WeChatWASM.RequestMidasFriendPaymentSuccessCallbackResult)checkSelf(l);
			pushValue(l,true);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.RequestMidasFriendPaymentSuccessCallbackResult");
		...
		createTypeMetatable(l,constructor, typeof(WeChatWASM.RequestMidasFriendPaymentSuccessCallbackResult));
	}
}
