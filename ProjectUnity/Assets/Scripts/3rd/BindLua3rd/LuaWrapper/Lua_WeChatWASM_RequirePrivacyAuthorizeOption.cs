...
public class Lua_WeChatWASM_RequirePrivacyAuthorizeOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.RequirePrivacyAuthorizeOption o;
			o=new WeChatWASM.RequirePrivacyAuthorizeOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int set_complete(IntPtr l) {
		try {
			WeChatWASM.RequirePrivacyAuthorizeOption self=(WeChatWASM.RequirePrivacyAuthorizeOption)checkSelf(l);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.RequirePrivacyAuthorizeOption");
		addMember(l,"complete",null,set_complete,true);
		addMember(l,"fail",null,set_fail,true);
		addMember(l,"success",null,set_success,true);
		createTypeMetatable(l,constructor, typeof(WeChatWASM.RequirePrivacyAuthorizeOption));
	}
}
