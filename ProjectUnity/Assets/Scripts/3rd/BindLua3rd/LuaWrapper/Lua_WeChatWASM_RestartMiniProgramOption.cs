...
public class Lua_WeChatWASM_RestartMiniProgramOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.RestartMiniProgramOption o;
			o=new WeChatWASM.RestartMiniProgramOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int set_complete(IntPtr l) {
		try {
			WeChatWASM.RestartMiniProgramOption self=(WeChatWASM.RestartMiniProgramOption)checkSelf(l);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.RestartMiniProgramOption");
		...
		createTypeMetatable(l,constructor, typeof(WeChatWASM.RestartMiniProgramOption));
	}
}
