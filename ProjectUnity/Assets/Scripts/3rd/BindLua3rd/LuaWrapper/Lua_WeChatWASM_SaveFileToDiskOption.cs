...
public class Lua_WeChatWASM_SaveFileToDiskOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.SaveFileToDiskOption o;
			o=new WeChatWASM.SaveFileToDiskOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_filePath(IntPtr l) {
		try {
			WeChatWASM.SaveFileToDiskOption self=(WeChatWASM.SaveFileToDiskOption)checkSelf(l);
			pushValue(l,true);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.SaveFileToDiskOption");
		...
		createTypeMetatable(l,constructor, typeof(WeChatWASM.SaveFileToDiskOption));
	}
}
