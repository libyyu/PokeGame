...
public class Lua_WeChatWASM_SetBLEMTUOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.SetBLEMTUOption o;
			o=new WeChatWASM.SetBLEMTUOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_deviceId(IntPtr l) {
		try {
			WeChatWASM.SetBLEMTUOption self=(WeChatWASM.SetBLEMTUOption)checkSelf(l);
			pushValue(l,true);
	...
	static public int set_fail(IntPtr l) {
		try {
			WeChatWASM.SetBLEMTUOption self=(WeChatWASM.SetBLEMTUOption)checkSelf(l);
			System.Action<WeChatWASM.SetBLEMTUFailCallbackResult> v;
			int op=checkDelegate(l,2,out v);
			if(op==0) self.fail=v;
	...
	static public int set_success(IntPtr l) {
		try {
			WeChatWASM.SetBLEMTUOption self=(WeChatWASM.SetBLEMTUOption)checkSelf(l);
			System.Action<WeChatWASM.SetBLEMTUSuccessCallbackResult> v;
			int op=checkDelegate(l,2,out v);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.SetBLEMTUOption");
		...
		createTypeMetatable(l,constructor, typeof(WeChatWASM.SetBLEMTUOption));
	}
}
