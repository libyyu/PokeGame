...
public class Lua_WeChatWASM_SetBackgroundFetchTokenOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.SetBackgroundFetchTokenOption o;
			o=new WeChatWASM.SetBackgroundFetchTokenOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_token(IntPtr l) {
		try {
			WeChatWASM.SetBackgroundFetchTokenOption self=(WeChatWASM.SetBackgroundFetchTokenOption)checkSelf(l);
			pushValue(l,true);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.SetBackgroundFetchTokenOption");
		...
		createTypeMetatable(l,constructor, typeof(WeChatWASM.SetBackgroundFetchTokenOption));
	}
}
