...
public class Lua_WeChatWASM_SetDeviceOrientationOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.SetDeviceOrientationOption o;
			o=new WeChatWASM.SetDeviceOrientationOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_value(IntPtr l) {
		try {
			WeChatWASM.SetDeviceOrientationOption self=(WeChatWASM.SetDeviceOrientationOption)checkSelf(l);
			pushValue(l,true);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.SetDeviceOrientationOption");
		...
		createTypeMetatable(l,constructor, typeof(WeChatWASM.SetDeviceOrientationOption));
	}
}
