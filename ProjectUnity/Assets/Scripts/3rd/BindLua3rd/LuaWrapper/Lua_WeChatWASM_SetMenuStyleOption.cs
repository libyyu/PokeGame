...
public class Lua_WeChatWASM_SetMenuStyleOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.SetMenuStyleOption o;
			o=new WeChatWASM.SetMenuStyleOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_style(IntPtr l) {
		try {
			WeChatWASM.SetMenuStyleOption self=(WeChatWASM.SetMenuStyleOption)checkSelf(l);
			pushValue(l,true);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.SetMenuStyleOption");
		...
		createTypeMetatable(l,constructor, typeof(WeChatWASM.SetMenuStyleOption));
	}
}
