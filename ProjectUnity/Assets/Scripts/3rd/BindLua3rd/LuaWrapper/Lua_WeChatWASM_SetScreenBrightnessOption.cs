...
public class Lua_WeChatWASM_SetScreenBrightnessOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.SetScreenBrightnessOption o;
			o=new WeChatWASM.SetScreenBrightnessOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_value(IntPtr l) {
		try {
			WeChatWASM.SetScreenBrightnessOption self=(WeChatWASM.SetScreenBrightnessOption)checkSelf(l);
			pushValue(l,true);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.SetScreenBrightnessOption");
		...
		createTypeMetatable(l,constructor, typeof(WeChatWASM.SetScreenBrightnessOption));
	}
}
