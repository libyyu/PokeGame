...
public class Lua_WeChatWASM_SetStatusBarStyleOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.SetStatusBarStyleOption o;
			o=new WeChatWASM.SetStatusBarStyleOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_style(IntPtr l) {
		try {
			WeChatWASM.SetStatusBarStyleOption self=(WeChatWASM.SetStatusBarStyleOption)checkSelf(l);
			pushValue(l,true);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.SetStatusBarStyleOption");
		...
		createTypeMetatable(l,constructor, typeof(WeChatWASM.SetStatusBarStyleOption));
	}
}
