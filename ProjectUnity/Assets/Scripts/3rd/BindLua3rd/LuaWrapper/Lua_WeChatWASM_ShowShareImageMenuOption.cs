...
public class Lua_WeChatWASM_ShowShareImageMenuOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.ShowShareImageMenuOption o;
			o=new WeChatWASM.ShowShareImageMenuOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_path(IntPtr l) {
		try {
			WeChatWASM.ShowShareImageMenuOption self=(WeChatWASM.ShowShareImageMenuOption)checkSelf(l);
			pushValue(l,true);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.ShowShareImageMenuOption");
		...
		createTypeMetatable(l,constructor, typeof(WeChatWASM.ShowShareImageMenuOption));
	}
}
