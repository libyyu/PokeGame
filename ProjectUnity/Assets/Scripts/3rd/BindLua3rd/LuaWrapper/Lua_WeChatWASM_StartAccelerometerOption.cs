...
public class Lua_WeChatWASM_StartAccelerometerOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.StartAccelerometerOption o;
			o=new WeChatWASM.StartAccelerometerOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int set_complete(IntPtr l) {
		try {
			WeChatWASM.StartAccelerometerOption self=(WeChatWASM.StartAccelerometerOption)checkSelf(l);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.StartAccelerometerOption");
		...
		createTypeMetatable(l,constructor, typeof(WeChatWASM.StartAccelerometerOption));
	}
}
