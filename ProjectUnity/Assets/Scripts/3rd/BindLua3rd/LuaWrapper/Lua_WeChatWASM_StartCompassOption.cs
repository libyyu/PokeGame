...
public class Lua_WeChatWASM_StartCompassOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.StartCompassOption o;
			o=new WeChatWASM.StartCompassOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int set_complete(IntPtr l) {
		try {
			WeChatWASM.StartCompassOption self=(WeChatWASM.StartCompassOption)checkSelf(l);
