...
public class Lua_WeChatWASM_StartDeviceMotionListeningOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.StartDeviceMotionListeningOption o;
			o=new WeChatWASM.StartDeviceMotionListeningOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int set_complete(IntPtr l) {
		try {
			WeChatWASM.StartDeviceMotionListeningOption self=(WeChatWASM.StartDeviceMotionListeningOption)checkSelf(l);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.StartDeviceMotionListeningOption");
		...
		createTypeMetatable(l,constructor, typeof(WeChatWASM.StartDeviceMotionListeningOption));
	}
}
