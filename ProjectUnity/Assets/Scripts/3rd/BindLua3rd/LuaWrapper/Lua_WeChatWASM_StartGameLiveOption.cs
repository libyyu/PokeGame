...
public class Lua_WeChatWASM_StartGameLiveOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.StartGameLiveOption o;
			o=new WeChatWASM.StartGameLiveOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_query(IntPtr l) {
		try {
			WeChatWASM.StartGameLiveOption self=(WeChatWASM.StartGameLiveOption)checkSelf(l);
			pushValue(l,true);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.StartGameLiveOption");
		...
		createTypeMetatable(l,constructor, typeof(WeChatWASM.StartGameLiveOption));
	}
}
