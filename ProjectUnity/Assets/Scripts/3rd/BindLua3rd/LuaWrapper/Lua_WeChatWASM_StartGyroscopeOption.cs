...
public class Lua_WeChatWASM_StartGyroscopeOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.StartGyroscopeOption o;
			o=new WeChatWASM.StartGyroscopeOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int set_complete(IntPtr l) {
		try {
			WeChatWASM.StartGyroscopeOption self=(WeChatWASM.StartGyroscopeOption)checkSelf(l);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.StartGyroscopeOption");
		...
		createTypeMetatable(l,constructor, typeof(WeChatWASM.StartGyroscopeOption));
	}
}
