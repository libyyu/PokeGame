...
public class Lua_WeChatWASM_StopCompassOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.StopCompassOption o;
			o=new WeChatWASM.StopCompassOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int set_complete(IntPtr l) {
		try {
			WeChatWASM.StopCompassOption self=(WeChatWASM.StopCompassOption)checkSelf(l);
