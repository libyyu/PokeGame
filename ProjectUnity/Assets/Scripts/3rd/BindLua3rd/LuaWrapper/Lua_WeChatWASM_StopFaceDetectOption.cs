...
public class Lua_WeChatWASM_StopFaceDetectOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.StopFaceDetectOption o;
			o=new WeChatWASM.StopFaceDetectOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int set_complete(IntPtr l) {
		try {
			WeChatWASM.StopFaceDetectOption self=(WeChatWASM.StopFaceDetectOption)checkSelf(l);
