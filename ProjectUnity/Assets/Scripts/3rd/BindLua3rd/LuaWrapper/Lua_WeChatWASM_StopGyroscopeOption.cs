...
public class Lua_WeChatWASM_StopGyroscopeOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.StopGyroscopeOption o;
			o=new WeChatWASM.StopGyroscopeOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int set_complete(IntPtr l) {
		try {
			WeChatWASM.StopGyroscopeOption self=(WeChatWASM.StopGyroscopeOption)checkSelf(l);
