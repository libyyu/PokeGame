...
public class Lua_WeChatWASM_UpdateKeyboardOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.UpdateKeyboardOption o;
			o=new WeChatWASM.UpdateKeyboardOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_value(IntPtr l) {
		try {
			WeChatWASM.UpdateKeyboardOption self=(WeChatWASM.UpdateKeyboardOption)checkSelf(l);
			pushValue(l,true);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.UpdateKeyboardOption");
		...
		createTypeMetatable(l,constructor, typeof(WeChatWASM.UpdateKeyboardOption));
	}
}
