...
public class Lua_WeChatWASM_VibrateLongOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.VibrateLongOption o;
			o=new WeChatWASM.VibrateLongOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int set_complete(IntPtr l) {
		try {
			WeChatWASM.VibrateLongOption self=(WeChatWASM.VibrateLongOption)checkSelf(l);
