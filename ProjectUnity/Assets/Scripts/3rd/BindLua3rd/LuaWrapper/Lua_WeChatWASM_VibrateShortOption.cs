...
public class Lua_WeChatWASM_VibrateShortOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.VibrateShortOption o;
			o=new WeChatWASM.VibrateShortOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_type(IntPtr l) {
		try {
			WeChatWASM.VibrateShortOption self=(WeChatWASM.VibrateShortOption)checkSelf(l);
			pushValue(l,true);
	...
	static public int set_fail(IntPtr l) {
		try {
			WeChatWASM.VibrateShortOption self=(WeChatWASM.VibrateShortOption)checkSelf(l);
			System.Action<WeChatWASM.VibrateShortFailCallbackResult> v;
			int op=checkDelegate(l,2,out v);
			if(op==0) self.fail=v;
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.VibrateShortOption");
		...
		createTypeMetatable(l,constructor, typeof(WeChatWASM.VibrateShortOption));
	}
}
