...
public class Lua_WeChatWASM_WXBaseResponse : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.WXBaseResponse o;
			o=new WeChatWASM.WXBaseResponse();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_callbackId(IntPtr l) {
		try {
			WeChatWASM.WXBaseResponse self=(WeChatWASM.WXBaseResponse)checkSelf(l);
			pushValue(l,true);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.WXBaseResponse");
		addMember(l,"callbackId",get_callbackId,set_callbackId,true);
		addMember(l,"errMsg",get_errMsg,set_errMsg,true);
		createTypeMetatable(l,constructor, typeof(WeChatWASM.WXBaseResponse));
	}
}
