...
public class Lua_WeChatWASM_WXCreateCustomAdParam : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.WXCreateCustomAdParam o;
			o=new WeChatWASM.WXCreateCustomAdParam();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_adUnitId(IntPtr l) {
		try {
			WeChatWASM.WXCreateCustomAdParam self=(WeChatWASM.WXCreateCustomAdParam)checkSelf(l);
			pushValue(l,true);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.WXCreateCustomAdParam");
		...
		createTypeMetatable(l,constructor, typeof(WeChatWASM.WXCreateCustomAdParam));
	}
}
