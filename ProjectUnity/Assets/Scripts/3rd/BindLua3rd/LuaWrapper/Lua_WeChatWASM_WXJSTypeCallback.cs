...
public class Lua_WeChatWASM_WXJSTypeCallback : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.WXJSTypeCallback o;
			o=new WeChatWASM.WXJSTypeCallback();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_callbackId(IntPtr l) {
		try {
			WeChatWASM.WXJSTypeCallback self=(WeChatWASM.WXJSTypeCallback)checkSelf(l);
			pushValue(l,true);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.WXJSTypeCallback");
		...
		createTypeMetatable(l,constructor, typeof(WeChatWASM.WXJSTypeCallback));
	}
}
