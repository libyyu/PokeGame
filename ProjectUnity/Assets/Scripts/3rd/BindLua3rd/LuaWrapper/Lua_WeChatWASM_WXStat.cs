...
public class Lua_WeChatWASM_WXStat : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.WXStat o;
			o=new WeChatWASM.WXStat();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_path(IntPtr l) {
		try {
			WeChatWASM.WXStat self=(WeChatWASM.WXStat)checkSelf(l);
			pushValue(l,true);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.WXStat");
		addMember(l,"path",get_path,set_path,true);
		addMember(l,"stats",get_stats,set_stats,true);
		createTypeMetatable(l,constructor, typeof(WeChatWASM.WXStat));
	}
}
