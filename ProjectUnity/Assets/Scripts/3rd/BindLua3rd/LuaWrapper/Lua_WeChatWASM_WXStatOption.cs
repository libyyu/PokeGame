...
public class Lua_WeChatWASM_WXStatOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.WXStatOption o;
			o=new WeChatWASM.WXStatOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_path(IntPtr l) {
		try {
			WeChatWASM.WXStatOption self=(WeChatWASM.WXStatOption)checkSelf(l);
			pushValue(l,true);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.WXStatOption");
		addMember(l,"path",get_path,set_path,true);
		addMember(l,"recursive",get_recursive,set_recursive,true);
		createTypeMetatable(l,constructor, typeof(WeChatWASM.WXStatOption));
	}
}
