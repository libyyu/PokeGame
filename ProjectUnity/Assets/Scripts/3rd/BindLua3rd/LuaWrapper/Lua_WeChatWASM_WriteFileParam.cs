...
public class Lua_WeChatWASM_WriteFileParam : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.WriteFileParam o;
			o=new WeChatWASM.WriteFileParam();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_filePath(IntPtr l) {
		try {
			WeChatWASM.WriteFileParam self=(WeChatWASM.WriteFileParam)checkSelf(l);
			pushValue(l,true);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.WriteFileParam");
		...
		createTypeMetatable(l,constructor, typeof(WeChatWASM.WriteFileParam));
	}
}
