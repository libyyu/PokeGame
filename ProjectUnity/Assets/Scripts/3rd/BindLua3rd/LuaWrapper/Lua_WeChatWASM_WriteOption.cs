...
public class Lua_WeChatWASM_WriteOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.WriteOption o;
			o=new WeChatWASM.WriteOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_data(IntPtr l) {
		try {
			WeChatWASM.WriteOption self=(WeChatWASM.WriteOption)checkSelf(l);
			pushValue(l,true);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.WriteOption");
		...
		createTypeMetatable(l,constructor, typeof(WeChatWASM.WriteOption));
	}
}
