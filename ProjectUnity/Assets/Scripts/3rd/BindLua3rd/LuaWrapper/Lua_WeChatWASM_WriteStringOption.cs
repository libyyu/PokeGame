...
public class Lua_WeChatWASM_WriteStringOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.WriteStringOption o;
			o=new WeChatWASM.WriteStringOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_data(IntPtr l) {
		try {
			WeChatWASM.WriteStringOption self=(WeChatWASM.WriteStringOption)checkSelf(l);
			pushValue(l,true);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.WriteStringOption");
		...
		createTypeMetatable(l,constructor, typeof(WeChatWASM.WriteStringOption));
	}
}
