...
public class Lua_WeChatWASM_WriteSyncStringOption : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.WriteSyncStringOption o;
			o=new WeChatWASM.WriteSyncStringOption();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_data(IntPtr l) {
		try {
			WeChatWASM.WriteSyncStringOption self=(WeChatWASM.WriteSyncStringOption)checkSelf(l);
			pushValue(l,true);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.WriteSyncStringOption");
		...
		createTypeMetatable(l,constructor, typeof(WeChatWASM.WriteSyncStringOption));
	}
}
