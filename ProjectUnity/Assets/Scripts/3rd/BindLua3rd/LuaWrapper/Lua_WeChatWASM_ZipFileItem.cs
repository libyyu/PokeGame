...
public class Lua_WeChatWASM_ZipFileItem : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			WeChatWASM.ZipFileItem o;
			o=new WeChatWASM.ZipFileItem();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_data(IntPtr l) {
		try {
			WeChatWASM.ZipFileItem self=(WeChatWASM.ZipFileItem)checkSelf(l);
			pushValue(l,true);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"WeChatWASM.ZipFileItem");
		addMember(l,"data",get_data,set_data,true);
		addMember(l,"errMsg",get_errMsg,set_errMsg,true);
		createTypeMetatable(l,constructor, typeof(WeChatWASM.ZipFileItem));
	}
}
