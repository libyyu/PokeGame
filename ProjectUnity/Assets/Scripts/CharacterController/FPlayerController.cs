...
public class FPlayerController : MonoBehaviour
{
    #region 摄像机相关
    [Header("Cinemachine")]
    private FVirtualCameraManager cmvCamManager;
    ...
    private FPlayerInputController _input;
    ...
    private void Start()
    {
        ...
        _input = GetComponent<FPlayerInputController>();
        //#if ENABLE_INPUT_SYSTEM && STARTER_ASSETS_PACKAGES_CHECKED
    ...
    void Update()
    {
        if (cmvCamManager == null && FVirtualCameraManager.Instance != null)
        {
    ...
    private void OnFootstep(AnimationEvent animationEvent)
    {
        if (animationEvent.animatorClipInfo.weight > 0.5f)
        {
            if (FootstepAudioClips.Length > 0)
            {
                ...
                FSoundManager.Instance.PlaySound(FootstepAudioClips[index], transform.TransformPoint(_controller.center));
            }
        }
    }
    ...
    private void OnLand(AnimationEvent animationEvent)
    {
        if (animationEvent.animatorClipInfo.weight > 0.5f)
        {
            ...
            FSoundManager.Instance.PlaySound(LandingAudioClip, transform.TransformPoint(_controller.center));
        }
    }
}
