	...
	public class ImageWithIndependentRoundedCorners : MonoBehaviour {
		...
		public void Validate() {
			if (material == null) {
				...
				if(shader == null)
				{
					const string assetPath = "Scripts/UI/UiRoundedCorners/IndependentRoundedCorners.shader";
                ...
                if (shader == null)
				{
					UnityEngine.Debug.LogWarning("Failed to load shader: IndependentRoundedCorners");
				}
                if (shader != null)
